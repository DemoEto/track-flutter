...
class AttendanceResultPage extends StatelessWidget {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          ...
          child: ListTile(
            title: Text(date),
            trailing: _buildStatusChip(record.status), // ✅ เอา "as String" ออก
          ),
        );
      },
    );
  ...
  Widget _buildStatusChip(AttendanceStatus status) { // ✅ เปลี่ยนจาก String เป็น AttendanceStatus
    Color color;
    String label;
...
//         return Card(
//           margin: const EdgeInsets.symmetric(vertical: 8),
//           child: ListTile(title: Text(date), trailing: _buildStatusChip(record.status)),
//         );
//       },
//     );
//   }
